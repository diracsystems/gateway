...
import { OrderItemDeleteDialogComponent } from 'app/entities/product/order-item/order-item-delete-dialog.component';
import { OrderItemService } from 'app/entities/product/order-item/order-item.service';
