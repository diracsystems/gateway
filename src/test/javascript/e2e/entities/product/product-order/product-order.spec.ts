...
describe('ProductOrder e2e test', () => {
  ...
  it('should load ProductOrders', async () => {
    ...
    expect(await productOrderComponentsPage.getTitle()).to.eq('gatewayApp.productProductOrder.home.title');
  });
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle()).to.eq('gatewayApp.productProductOrder.home.createOrEditLabel');
  ...
  it('should create and save ProductOrders', async () => {
    ...
    expect(await productOrderUpdatePage.getCustomerInput()).to.eq('customer', 'Expected Customer value to be equals to customer');
  ...
  it('should delete last ProductOrder', async () => {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle()).to.eq('gatewayApp.productProductOrder.delete.question');
